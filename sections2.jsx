...
function Impact() {
  return (
    <section className="section impact-sec" id="impact">
      <div className="wrap">
...
function DashboardSection({ DashEl, openLOI }) {
  return (
    <section className="section dash-sec" id="dashboard">
      <div className="wrap">
        ...
        <div className="reveal" style={{ marginTop: 16 }}><SavingsCalculator openLOI={openLOI} /></div>
      </div>
    </section>);
...
function Proof() {
  return (
    <section className="section proof-sec" id="testimonials">
      <div className="wrap">
        <h2 className="h-display reveal" style={{ textAlign: "center", maxWidth: 900, margin: "0 auto 48px" }}>The Results Speak for Themselves</h2>
